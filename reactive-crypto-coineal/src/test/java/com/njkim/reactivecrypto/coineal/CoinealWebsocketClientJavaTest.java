...
public class CoinealWebsocketClientJavaTest {
    @Test
    public void tick_data_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USDT");
        Flux<TickData> tickDataFlux = new CoinealWebsocketClient()
    ...
    public void orderBook_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USDT");
        Flux<OrderBook> orderBookFlux = new CoinealWebsocketClient()
