...
import com.njkim.reactivecrypto.coineal.http.raw.CoinealRawPrivateHttpClient
...
class CoinealPrivateHttpClient(
    accessKey: String,
    secretKey: String,
    ...
    override fun order(): OrderOperation {
        return CoinealOrderOperator(
            accessKey,
            secretKey,
            coinealRawPrivateHttpClient.order()
        )
    }
}