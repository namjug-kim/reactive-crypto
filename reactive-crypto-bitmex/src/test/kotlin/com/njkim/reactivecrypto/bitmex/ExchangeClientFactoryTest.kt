...
class ExchangeClientFactoryTest {
    @Test
    fun `create bitmex websocket client`() {
        val exchangeWebsocketClient = ExchangeClientFactory.publicWebsocket(ExchangeVendor.BITMEX)
        ...
        assertThat(exchangeWebsocketClient).isExactlyInstanceOf(BitmexWebsocketClient::class.java)
    }
}
