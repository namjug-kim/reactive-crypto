...
public class ExchangeClientFactoryJavaTest {
    @Test
    public void bitmax() {
        ExchangePublicWebsocketClient exchangeWebsocketClient = ExchangeClientFactory.publicWebsocket(ExchangeVendor.IDAX);
        ...
        assertThat(exchangeWebsocketClient).isExactlyInstanceOf(IdaxWebsocketClient.class);
    }
}
