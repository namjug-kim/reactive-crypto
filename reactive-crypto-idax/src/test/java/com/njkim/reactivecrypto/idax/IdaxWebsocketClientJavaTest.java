...
public class IdaxWebsocketClientJavaTest {
    @Test
    public void tick_data_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USDT");
        Flux<TickData> tickDataFlux = new IdaxWebsocketClient()
        ...
        StepVerifier.create(tickDataFlux.limitRequest(5))
                ...
                .assertNext(tickData -> {
                    ...
                    assertThat(tickData.getExchangeVendor())
                            .isEqualByComparingTo(ExchangeVendor.IDAX);
    ...
    public void orderBook_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USDT");
        Flux<OrderBook> orderBookFlux = new IdaxWebsocketClient()
