...
class ExchangeClientFactoryTest {
    ...
    fun `create websocket client`() {
        val exchangeWebsocketClient = ExchangeClientFactory.publicWebsocket(ExchangeVendor.IDAX)
        ...
        assertThat(exchangeWebsocketClient).isExactlyInstanceOf(IdaxWebsocketClient::class.java)
    }
}
