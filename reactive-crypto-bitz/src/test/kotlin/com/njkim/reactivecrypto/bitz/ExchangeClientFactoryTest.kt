...
class ExchangeClientFactoryTest {
    ...
    fun `create websocket client`() {
        val exchangeWebsocketClient = ExchangeClientFactory.publicWebsocket(ExchangeVendor.BITZ)
        ...
        assertThat(exchangeWebsocketClient).isExactlyInstanceOf(BitzWebsocketClient::class.java)
    }
}
