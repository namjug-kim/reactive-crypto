...
data class Currency(val symbol: String) {
    companion object {
        ...
        @JvmField
        val UIP = getInstance("UIP")
        @JvmField
        val JST = getInstance("JST")
        @JvmField
        val SSX = getInstance("SSX")
        @JvmField
        val PLA = getInstance("PLA")
        @JvmField
        val HBAR = getInstance("HBAR")
        @JvmField
        val SXP = getInstance("SXP")
        @JvmField
        val BORA = getInstance("BORA")
        @JvmField
        ...
        @JvmField
        val ZKS = getInstance("ZKS")
        @JvmField
        val CAN = getInstance("CAN")
        @JvmField
        val FORTH = getInstance("FORTH")
        @JvmField
        val APN = getInstance("APN")
        @JvmField
        val STAKE = getInstance("STAKE")
        @JvmField
        val MIR = getInstance("MIR")
        @JvmField
        val INSUR = getInstance("INSUR")
        @JvmField
        ...
        @JvmField
        val CRE = getInstance("CRE")
        @JvmField
        val TKO = getInstance("TKO")
        @JvmField
        val BAR = getInstance("BAR")
        @JvmField
        val SUPER = getInstance("SUPER")
        @JvmField
        val LINA = getInstance("LINA")
        @JvmField
        val CHR = getInstance("CHR")
        @JvmField
        val OXT = getInstance("OXT")
        @JvmField
        val OGN = getInstance("OGN")
        @JvmField
