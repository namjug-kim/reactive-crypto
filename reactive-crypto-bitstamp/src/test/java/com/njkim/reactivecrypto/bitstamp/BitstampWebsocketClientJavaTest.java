...
public class BitstampWebsocketClientJavaTest {
    @Test
    public void tick_data_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USD");
        Flux<TickData> tickDataFlux = new BitstampWebsocketClient()
    ...
    public void orderBook_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USD");
        Flux<OrderBook> orderBookFlux = new BitstampWebsocketClient()
