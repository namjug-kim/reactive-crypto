...
class ExchangeClientFactoryTest {
    ...
    fun `create websocket client`() {
        val exchangeWebsocketClient = ExchangeClientFactory.publicWebsocket(ExchangeVendor.BITSTAMP)
        ...
        assertThat(exchangeWebsocketClient).isExactlyInstanceOf(BitstampWebsocketClient::class.java)
    }
}
