...
class ExchangeClientFactoryTest {
    ...
    fun `create websocket client`() {
        val exchangeWebsocketClient = ExchangeClientFactory.publicWebsocket(ExchangeVendor.POLONIEX)
        ...
        assertThat(exchangeWebsocketClient).isExactlyInstanceOf(PoloniexWebsocketClient::class.java)
    }
}
