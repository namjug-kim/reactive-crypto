...
class PoloniexWebsocketClientTest {
    private val log = KotlinLogging.logger {}

    @Test
    fun `tick data subscribe`() {
        // given
        val targetCurrencyPair = CurrencyPair.parse("XRP", "BTC")
        val tickDataFlux = PoloniexWebsocketClient()
        ...
        StepVerifier.create(tickDataFlux.limitRequest(3))
            ...
            .assertNext {
                ...
                Assertions.assertThat(it.exchangeVendor)
                    .isEqualByComparingTo(ExchangeVendor.POLONIEX)
    ...
    fun `orderBook subscribe`() {
        // given
        val targetCurrencyPair = CurrencyPair.parse("XRP", "BTC")
        val orderBookFlux = PoloniexWebsocketClient()
