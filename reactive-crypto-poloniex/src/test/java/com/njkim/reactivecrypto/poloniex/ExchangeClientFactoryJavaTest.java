...
public class ExchangeClientFactoryJavaTest {
    ...
    public void websocketClientTest() {
        ExchangePublicWebsocketClient exchangeWebsocketClient = ExchangeClientFactory.publicWebsocket(ExchangeVendor.POLONIEX);
        ...
        assertThat(exchangeWebsocketClient).isExactlyInstanceOf(PoloniexWebsocketClient.class);
    }
}
