...
public class KrakenWebsocketClientJavaTest {
    @Test
    public void kraken_tick_data_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("XBT", "USD");
        Flux<TickData> tickDataFlux = new KrakenWebsocketClient()
        ...
        StepVerifier.create(tickDataFlux.limitRequest(5))
                ...
                .assertNext(tickData -> {
                    ...
                    assertThat(tickData.getExchangeVendor())
                            .isEqualTo(ExchangeVendor.KRAKEN);
    ...
    @Test
    public void kraken_orderBook_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("XBT", "USD");
        Flux<OrderBook> orderBookFlux = new KrakenWebsocketClient()
