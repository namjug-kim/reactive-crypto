...
class OkexKoreaWebsocketClientTest {
    private val log = KotlinLogging.logger {}

    @Test
    fun `okex korea tick data subscribe`() {
        // given
        val targetCurrencyPair = CurrencyPair.parse("BTC", "USDT")
        val okexTickDataFlux = OkexKoreaWebsocketClient()
    ...
    fun `okex orderBook subscribe`() {
        // given
        val targetCurrencyPair = CurrencyPair.parse("BTC", "USDT")
        val orderBookFlux = OkexKoreaWebsocketClient()
