...
public class OkexKoreaWebsocketClientJavaTest {
    @Test
    public void okex_tick_data_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USDT");
        Flux<TickData> tickDataFlux = new OkexKoreaWebsocketClient()
        ...
        StepVerifier.create(tickDataFlux.limitRequest(2))
                ...
                .assertNext(tickData -> {
                    ...
                    assertThat(tickData.getExchangeVendor())
                            .isEqualByComparingTo(ExchangeVendor.OKEX_KOREA);
    ...
    @Test
    public void okex_orderBook_subscribe() {
        // given
        CurrencyPair targetCurrencyPair = CurrencyPair.parse("BTC", "USDT");
        Flux<OrderBook> orderBookFlux = new OkexKoreaWebsocketClient()
